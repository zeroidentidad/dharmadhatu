...
<div id="formEditarPerfil" style="display:none" class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
   ...
   <form style="padding:20px" method="post" enctype="multipart/form-data">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
          <input name="editarPassword" type="password" placeholder="Contraseña de hasta 10 caracteres" maxlength="10" class="form-control" required>
      </div>
      ...
      <div class="form-group">
        <select name="editarRol" class="form-control" required>
            ...
            <option value="0" <?php if($_SESSION["rol"]==0) echo 'selected';?>>Administrador</option>
            <option value="1" <?php if($_SESSION["rol"]==1) echo 'selected';?>>Editor</option>
        </select>
      </div>
       ...
       <div class="form-group text-center">
          ...
          <p class="text-center" style="font-size:12px">Tamaño recomendado de imagen: 100px * 100px, peso máximo 2MB</p>
       </div>
...
echo '<div id="crearPerfil" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    ...
    <form id="formularioPerfil" style="display:none" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <input name="nuevoUsuario" type="text" placeholder="Nombre usuario de hasta 10 caracteres" maxlength="10" class="form-control"  required>
      </div>

        <div class="form-group">
            <input name="nuevoPassword" type="password" placeholder="Contraseña hasta 10 caracteres" maxlength="10" class="form-control" required>
        </div>

        <div class="form-group">
          <input name="nuevoEmail" type="email" placeholder="Correo electrónico" class="form-control" required>
        </div>
      ...
      <input type="submit" id="guardarPerfil" value="Guardar" class="btn btn-primary">
