...
class GestorSlideModel {
	...
	public function mostrarImagenSlideModel($datos, $tabla){
        ...
        $obj = new Conexion();
		$stmt = $obj->conectar()->prepare("SELECT ruta, titulo, descripcion FROM $tabla WHERE ruta = :ruta");
	...
	public function mostrarImagenVistaModel($tabla){
        ...
        $obj = new Conexion();
		$stmt = $obj->conectar()->prepare("SELECT id, ruta, titulo, descripcion FROM $tabla ORDER BY orden ASC");
	...
	public function actualizarSlideModel($datos, $tabla){
        ...
        $obj = new Conexion();
		$stmt = $obj->conectar()->prepare("UPDATE $tabla SET titulo = :titulo, descripcion = :descripcion WHERE id = :id");	
	...
	public function seleccionarActualizacionSlideModel($datos, $tabla){
        ...
        $obj = new Conexion();
		$stmt = $obj->conectar()->prepare("SELECT titulo, descripcion FROM $tabla WHERE id = :id");
