<header class="row">
	...
	<div id="logo" class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
		...
		<img src="views/images/logotipo.png" class="img-responsive" alt="DHARMADHATU">
	...
	<nav id="botonera" class="col-lg-9 col-md-9 col-sm-12 col-xs-12 collapse navbar-collapse pull-right">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="#top"><b>Noticias</b></a></li>
			<li><a href="#galeria"><b>Galería</b></a></li>
			<li><a href="#articulos"><b>Artículos</b></a></li>
			<li><a href="#videos"><b>Videos</b></a></li>
			<li><a href="#contactenos"><b>Contacto</b></a></li>
