...
$encabezado = <<<EOF
	...
	<table style="border: 1px solid #333; text-align:center; line-height: 20px; font-size:10px">
		<tr>
			<td style="border: 1px solid #666; background-color:#333; color:#fff"><b>Nombre</b></td>
			<td style="border: 1px solid #666; background-color:#333; color:#fff"><b>Email</b></td>
		</tr>
	</table>
EOF;
...
$respuesta = $obj->impresionSuscriptoresController("suscriptores");
...
$pdf->writeHTML($listado, false, false, false, false, '');
}
...
$salida = new ImpresionSuscriptores();
$salida -> imprimirSuscriptores();
?>